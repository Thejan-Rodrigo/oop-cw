...
public class SimConfiguration {
    ...
    public SimConfiguration(int totalTickets, int ticketReleaseRate, int customerRetrievalRate, int maxTicketCapacity){
    ...
    public void saveConfig(SimConfiguration configuration){
        Gson gson = new Gson();
    ...
    public void loadConfig(){
        ...
        try {
            ...
            SimConfiguration data = gson.fromJson(reader, SimConfiguration.class);
